...
router.post('/user/register', function(req, res, next) {
    ...
    var reg1 = /tuijianSecond/;
    var reg2 = /tuijianThird/;
    ...
    if (!(username && password && phoneNumber && bankNumber)) {
        ...
        if (invitation_code_from_people && (reg1.test(invitation_code_from_people) || reg2.test(invitation_code_from_people) || reg3.test(invitation_code_from_people))) {
            //用户是否已经被注册
            User.findOne({
